...
export interface TaskIntegration {
   ...
   */
  getAvailableAssignees(projectPath: string): Promise<Array<{id: string; name: string; type: string}>>;
...
export interface TaskIntegrationFactory {
   ...
   */
  validateConfig(type: string, config: Record<string, unknown>): Promise<{valid: boolean; errors: string[]}>;
}
 ...
 * Errors
 */
export class TaskIntegrationError extends Error {
  constructor(
    message: string,
...
export class TaskNotFoundError extends TaskIntegrationError {
...
export class TaskIntegrationNotAvailableError extends TaskIntegrationError {
...
export class InvalidTaskOperationError extends TaskIntegrationError {
